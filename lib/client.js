window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function LearnCompanion({ useCompanion, startReview }) {
			...
			const [reviewingNodeId, setReviewingNodeId] = (0, react.useState)(null);
			const [reviewError, setReviewError] = (0, react.useState)(null);
			...
			const beginReview = (0, react.useCallback)(async (node) => {
			...
			const desiredCardHeight = Math.min(260, 92 + skillTree.reduce((height, item) => height + 48 + Math.min(2, item.node.resources.length) * 21, 0));
			const availableAbove = Math.max(100, position.y - VIEWPORT_MARGIN - 6);
			const availableBelow = Math.max(100, window.innerHeight - position.y - SCENE_HEIGHT - VIEWPORT_MARGIN - 6);
			const cardPlacement = availableBelow < desiredCardHeight && availableAbove > availableBelow ? "above" : "below";
			const detailStyle = { maxHeight: `${Math.min(desiredCardHeight, cardPlacement === "above" ? availableAbove : availableBelow)}px` };
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						"aria-label": "学习详情",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dsh-learn-card-summary",
							children: [
						...
						}), skillTree.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							className: "dsh-learn-tree",
							"aria-label": "课程技能树",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dsh-learn-tree-heading",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "技能树" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [skillTree.length, " 项"] })]
								}),
								reviewError !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dsh-learn-review-error",
									role: "alert",
									children: reviewError
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dsh-learn-tree-list",
									children: skillTree.map(({ node, depth }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												className: "dsh-learn-skill-line",
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dsh-learn-tree-branch",
														"aria-hidden": "true",
														children: reviewingNodeId === node.id ? "…" : depth === 0 ? "◆" : "└"
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														className: "dsh-learn-skill-names",
														title: `${node.title} / ${node.titleEn}`,
														children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															className: "dsh-learn-skill-title",
															children: displayTitle(node.title)
														}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															className: "dsh-learn-skill-title-en",
															children: displayTitle(node.titleEn)
														})]
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dsh-learn-skill-score",
														children: reviewingNodeId === node.id ? "发送中" : `${node.mastery}%`
													})
												]
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "dsh-learn-mastery-track",
												"aria-hidden": "true",
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: { width: `${node.mastery}%` } })
											})]
										}), node.resources.slice(0, 2).map((resource) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("a", {
		...
		function flattenSkillTree(nodes) {
		...
		function parseSnapshot(value) {
			...
			const input = value;
			if (input.domainId !== null && typeof input.domainId !== "string" || input.domainTitle !== null && typeof input.domainTitle !== "string" || !isNatural(input.xp) || !isNatural(input.level) || input.level < 1 || !isNatural(input.levelProgress) || input.levelProgress > 100 || !isNatural(input.streak) || !isNatural(input.dueCount) || !Array.isArray(input.nodes) || typeof input.revision !== "string") throw new Error("Host returned a malformed dsh-learn snapshot");
			const nodes = input.nodes.map(parseNode);
			if (nodes.length > 100 || new Set(nodes.map((node) => node.id)).size !== nodes.length) throw new Error("Host returned a malformed dsh-learn skill tree");
			return {
		...
		function parseNode(value) {
			if (value === null || typeof value !== "object" || Array.isArray(value)) throw new Error("Host returned a malformed dsh-learn skill node");
			const input = value;
			if (typeof input.id !== "string" || typeof input.title !== "string" || typeof input.titleEn !== "string" || input.parent !== null && typeof input.parent !== "string" || !isNatural(input.mastery) || input.mastery > 100 || !isNatural(input.leverage) || input.leverage > 100 || !Array.isArray(input.resources)) throw new Error("Host returned a malformed dsh-learn skill node");
			return {
				id: input.id,
				title: input.title,
		...
		function parseResource(value) {
			if (value === null || typeof value !== "object" || Array.isArray(value)) throw new Error("Host returned a malformed dsh-learn node resource");
			const input = value;
			if (typeof input.title !== "string" || typeof input.url !== "string") throw new Error("Host returned a malformed dsh-learn node resource");
			let url;
			try {
			...
			if (url.protocol !== "http:" && url.protocol !== "https:") throw new Error("Host returned an unsafe dsh-learn node resource URL");
			return {
				title: input.title,
				url: url.toString()
			};
...
`;
		...
		*/
		...
		async function startReview(ctx, node) {
			const sessionId = ctx.sessions.list.getSnapshot().current;
			if (sessionId === void 0) throw new Error("请先打开一个会话，再开始复习。");
			const conversation = ctx.sessions.scope(sessionId)?.get("conversation");
			if (conversation === void 0) throw new Error("当前会话暂时无法接收复习请求。");
			const resources = node.resources.slice(0, 3).map((resource) => `- ${resource.title}: ${resource.url}`).join("\n");
			const prompt = [

	...
	factory: (require) => {
		...
		*/
		function LearnCompanion({ useCompanion }) {
			...
			const plantStyle = { "--plant-growth": String(.94 + snapshot.levelProgress * 6e-4) };
			const floatStyle = { transform: `translate3d(${position.x}px, ${position.y}px, 0)` };
			const title = snapshot.domainTitle ?? "学习伙伴休息中";
			const meta = snapshot.domainId === null ? "创建课程后植物会发芽" : `${STAGE_NAMES[stage - 1]} · ${snapshot.levelProgress}% · ${snapshot.dueCount} 项待复习`;
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										...
										d: "M25 34H18V31H9V22H18V25H25Z"
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										className: "dsh-learn-plant-leaf dsh-learn-plant-leaf-right",
										d: "M31 27H37V23H47V14H38V17H31Z"
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										className: "dsh-learn-plant-leaf dsh-learn-plant-leaf-upper",
										d: "M25 21H19V17H14V9H22V12H28Z"
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
										className: "dsh-learn-plant-bud",
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M21 12V6H24V3H32V6H35V12H32V16H24V12Z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
											x: "25",
											y: "7",
											width: "6",
											height: "6"
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										className: "dsh-learn-pot-motif",
										d: "M25 49H31V52H34V56H31V59H25V56H22V52H25Z"
									})
								]
							})
						})]
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["LV.", snapshot.level] }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [snapshot.xp, " XP"] }),
